...
Reader-friendly Documentation can be found [here](https://cartalyst.com/manual/platform-permissions/6.0).

Raw files can be found [here](https://github.com/cartalyst/platform-permissions/tree/docs/6.0).
